...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="snap-section relative grid-bg flex flex-col justify-center items-center h-screen overflow-hidden"
    >
      ...
      >
        <div className="max-w-6xl mx-auto flex justify-center relative z-10">
          ...
          >
            <RetroButton color="neonPink" onClick={() => scrollToElement("about")}>
              SOBRE
            </RetroButton>

            <RetroButton color="electricBlue" onClick={() => scrollToElement("skills")}>
              SKILLS
            </RetroButton>

            <RetroButton color="cyberYellow" onClick={() => scrollToElement("projects")}>
              PROJETOS
            </RetroButton>

            <RetroButton color="offWhite" onClick={() => scrollToElement("contact")}>
              CONTATO
            </RetroButton>
          </motion.div>
        </div>
